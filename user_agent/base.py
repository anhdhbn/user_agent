...
FIREFOX_VERSION = (
    ...
    ('53.0', datetime(2017, 4, 18)),
    ('54.0', datetime(2017, 6, 13)),
    ('55.0', datetime(2017, 8, 8)),
    ('56.0', datetime(2017, 9, 26)),
    ...
    ('95.0', datetime(2021, 12, 7)),
    ('96.0', datetime(2022, 1, 11)),
    ('97.0', datetime(2022, 2, 8)),
    ('98.0', datetime(2022, 3, 8)),
    ('99.0', datetime(2022, 4, 5)),
    ('100.0', datetime(2022, 5, 3)),
)
